...
#            car_y = car_y.insert(i,int (car_point[1]))
        ...
        if (array[0][0]> 300 and array[0][0] < 500):
            print ("car in left lane")
            cv2.putText(im_with_keypoints, "lane 1",(300,50), cv2.FONT_ITALIC, 1,(0,0,0),2,cv2.LINE_AA)     
        if (array[0][0]> 500 and array[0][0] < 700):    
            cv2.putText(im_with_keypoints, "lane 2",(500,50), cv2.FONT_ITALIC, 1,(0,0,0),2,cv2.LINE_AA)
        if (array[0][0]> 700 and array[0][0] < 900):
            cv2.putText(im_with_keypoints, "lane 3",(800,50), cv2.FONT_ITALIC, 1,(0,0,0),2,cv2.LINE_AA)
        if (array[0][0]> 700 and array[0][0] < 900):
            cv2.putText(im_with_keypoints, "lane 4",(800,50), cv2.FONT_ITALIC, 1,(0,0,0),2,cv2.LINE_AA)
        if (array[0][0]> 700 and array[0][0] < 900):
            cv2.putText(im_with_keypoints, "lane 5",(800,50), cv2.FONT_ITALIC, 1,(0,0,0),2,cv2.LINE_AA)
